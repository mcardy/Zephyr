...
public class SpongeAspectRegister implements Manager {
	...
	public void onEnable() {
		...
		add(ItemTypes.APPLE, Aspect.LIFE, 2, Aspect.LIFE, 1);
		add(ItemTypes.ARROW, Aspect.WEAPON, 4, Aspect.WOOD, 1);

		add(ItemTypes.BAKED_POTATO, Aspect.LIFE, 2, Aspect.LIFE, 1);
		add(ItemTypes.BEACON, Aspect.MAGIC, 32, Aspect.VALUE, 64);
		add(ItemTypes.BED, Aspect.WOOD, 6, Aspect.LIFE, 1);
		add(ItemTypes.BEEF, Aspect.BEAST, 4);
		add(ItemTypes.BIRCH_STAIRS, Aspect.WOOD, 2);
		add(ItemTypes.BLAZE_POWDER, Aspect.FIRE, 4, Aspect.MAGIC, 1);
		add(ItemTypes.BLAZE_ROD, Aspect.FIRE, 8, Aspect.MAGIC, 2);
		add(ItemTypes.BOAT, Aspect.WOOD, 10, Aspect.WATER, 5, Aspect.MOVEMENT, 10);
		add(ItemTypes.BONE, Aspect.DEATH, 1);
		add(ItemTypes.BOOK, Aspect.KNOWLEDGE, 8, Aspect.LIFE, 4);
		add(ItemTypes.BOOKSHELF, Aspect.KNOWLEDGE, 24, Aspect.WOOD, 12, Aspect.LIFE, 12);
		add(ItemTypes.BOW, Aspect.WEAPON, 8, Aspect.LIFE, 2, Aspect.WOOD, 3);
		add(ItemTypes.BOWL, Aspect.WOOD, 3, Aspect.VOID, 1);
		add(ItemTypes.BREAD, Aspect.LIFE, 2, Aspect.LIFE, 2);
		add(ItemTypes.BRICK, Aspect.STONE, 4, Aspect.EARTH, 4);
		add(ItemTypes.BRICK_STAIRS, Aspect.STONE, 2, Aspect.EARTH, 2);
		add(ItemTypes.BROWN_MUSHROOM, Aspect.LIFE, 2, Aspect.LIFE, 2);
		add(ItemTypes.BUCKET, Aspect.METAL, 24, Aspect.VOID, 4);

		add(ItemTypes.CACTUS, Aspect.WEAPON, 1, Aspect.LIFE, 4, Aspect.LIFE, 1);
		add(ItemTypes.CAKE, Aspect.LIFE, 4);
		add(ItemTypes.CARPET, Aspect.BEAST, 1);
		add(ItemTypes.CARROT, Aspect.LIFE, 2, Aspect.LIFE, 2);
		add(ItemTypes.CARROT_ON_A_STICK, Aspect.WOOD, 1, Aspect.LIFE, 2, Aspect.LIFE, 2, Aspect.MOVEMENT, 2);
		...
		add(ItemTypes.CHEST_MINECART, Aspect.METAL, 40, Aspect.MACHINE, 8, Aspect.MOVEMENT, 8, Aspect.WOOD, 8,
				Aspect.VOID, 8);
		add(ItemTypes.CHICKEN, Aspect.BEAST, 4);
		...
		add(ItemTypes.COAL, Aspect.FIRE, 2);
		add(ItemTypes.COAL_BLOCK, Aspect.FIRE, 18);
		add(ItemTypes.COAL_ORE, Aspect.FIRE, 2, Aspect.STONE, 2);
		...
		add(ItemTypes.COMPARATOR, Aspect.MACHINE, 8, Aspect.STONE, 4);
		add(ItemTypes.COMPASS, Aspect.METAL, 4, Aspect.KNOWLEDGE, 1, Aspect.MOVEMENT, 1, Aspect.MACHINE, 2);
		add(ItemTypes.COOKED_BEEF, Aspect.LIFE, 2, Aspect.BEAST, 2);
		add(ItemTypes.COOKED_CHICKEN, Aspect.LIFE, 2, Aspect.BEAST, 2);
		add(ItemTypes.COOKED_FISH, Aspect.LIFE, 2, Aspect.BEAST, 2);
		add(ItemTypes.COOKED_PORKCHOP, Aspect.BEAST, 2, Aspect.LIFE, 2);
		add(ItemTypes.COOKED_MUTTON, Aspect.BEAST, 2, Aspect.LIFE, 2);
		add(ItemTypes.COOKED_RABBIT, Aspect.BEAST, 2, Aspect.LIFE, 2);
		add(ItemTypes.COOKIE, Aspect.LIFE, 4, Aspect.LIFE, 1);
		...
		add(ItemTypes.DEADBUSH, Aspect.DEATH, 1, Aspect.LIFE, 1);
		...
		add(ItemTypes.DRAGON_EGG, Aspect.ENDER, 128, Aspect.DEATH, 128, Aspect.LIFE, 128, Aspect.DARKNESS, 128,
		...
		add(ItemTypes.ENCHANTED_BOOK, Aspect.MAGIC, 8, Aspect.KNOWLEDGE, 8);
		add(ItemTypes.ENCHANTING_TABLE, Aspect.MAGIC, 16, Aspect.KNOWLEDGE, 16);
		...
		add(ItemTypes.ENDER_EYE, Aspect.FIRE, 2, Aspect.ENDER, 8, Aspect.MAGIC, 4);
		...
		add(ItemTypes.FERMENTED_SPIDER_EYE, Aspect.DEATH, 2, Aspect.BEAST, 1);
		add(ItemTypes.FIRE_CHARGE, Aspect.DESTRUCTION, 4, Aspect.FIRE, 4);
		add(ItemTypes.FIREWORKS, Aspect.FIRE, 2, Aspect.LIGHT, 4);
		add(ItemTypes.FIREWORK_CHARGE, Aspect.FIRE, 2, Aspect.LIGHT, 4);
		add(ItemTypes.FISH, Aspect.BEAST, 4);
		...
		add(ItemTypes.FURNACE_MINECART, Aspect.MACHINE, 8, Aspect.MOVEMENT, 8, Aspect.METAL, 40);

		add(ItemTypes.GHAST_TEAR, Aspect.BEAST, 2, Aspect.MAGIC, 2, Aspect.FIRE, 2, Aspect.DEATH, 2);
		...
		add(ItemTypes.GOLDEN_RAIL, Aspect.METAL, 4, Aspect.MACHINE, 1);
		add(ItemTypes.GRASS, Aspect.EARTH, 1, Aspect.LIFE, 1);
		add(ItemTypes.GRAVEL, Aspect.EARTH, 1, Aspect.STONE, 1);
		add(ItemTypes.GUNPOWDER, Aspect.DESTRUCTION, 8, Aspect.BEAST, 2);

		add(ItemTypes.HARDENED_CLAY, Aspect.STONE, 2);
		add(ItemTypes.HAY_BLOCK, Aspect.LIFE, 2);
		...
		add(ItemTypes.LEAVES, Aspect.LIFE, 1);
		add(ItemTypes.LEAVES2, Aspect.LIFE, 1);
		add(ItemTypes.LEVER, Aspect.MACHINE, 2);
		add(ItemTypes.LIT_PUMPKIN, Aspect.LIGHT, 8, Aspect.LIFE, 8, Aspect.LIFE, 8);
		...
		add(ItemTypes.MAP, Aspect.TOOL, 8, Aspect.LIFE, 4, Aspect.KNOWLEDGE, 8);
		add(ItemTypes.MELON, Aspect.LIFE, 1, Aspect.LIFE, 1);
		add(ItemTypes.MELON_BLOCK, Aspect.LIFE, 8, Aspect.LIFE, 8);
		...
		add(ItemTypes.MOSSY_COBBLESTONE, Aspect.STONE, 1, Aspect.LIFE, 1);
		add(ItemTypes.MUSHROOM_STEW, Aspect.LIFE, 2, Aspect.LIFE, 4);
		add(ItemTypes.MYCELIUM, Aspect.EARTH, 1, Aspect.LIFE, 1, Aspect.MAGIC, 1);

		add(ItemTypes.NAME_TAG, Aspect.BEAST);
		add(ItemTypes.NETHER_BRICK, Aspect.DEATH, 1, Aspect.STONE, 4, Aspect.FIRE, 1);
		add(ItemTypes.NETHERBRICK, Aspect.STONE, 1);
		add(ItemTypes.NETHER_BRICK_STAIRS, Aspect.DEATH, 1, Aspect.STONE, 4, Aspect.FIRE, 1);
		add(ItemTypes.NETHER_BRICK_FENCE, Aspect.DEATH, 1, Aspect.STONE, 4, Aspect.FIRE, 1);
		add(ItemTypes.NETHER_WART, Aspect.DEATH, 2, Aspect.LIFE, 2);
		add(ItemTypes.NETHER_STAR, Aspect.MAGIC, 128);
		...
		add(ItemTypes.PAPER, Aspect.LIFE, 2, Aspect.KNOWLEDGE, 1);
		add(ItemTypes.PISTON, Aspect.MACHINE, 8, Aspect.STONE, 8, Aspect.WOOD, 4, 4, Aspect.MOVEMENT, 4);
		add(ItemTypes.PLANKS, Aspect.WOOD, 2);
		add(ItemTypes.POISONOUS_POTATO, Aspect.DEATH, 2, Aspect.LIFE, 2);
		add(ItemTypes.POTATO, Aspect.LIFE, 2, Aspect.LIFE, 2);
		add(ItemTypes.FURNACE_MINECART, Aspect.MACHINE, 8, Aspect.MOVEMENT, 8, Aspect.METAL, 40);
		add(ItemTypes.PUMPKIN, Aspect.LIFE, 8, Aspect.LIFE, 8);
		add(ItemTypes.PUMPKIN_PIE, Aspect.LIFE, 8, Aspect.LIFE, 4, Aspect.BEAST, 2);
		...
		add(ItemTypes.RED_MUSHROOM, Aspect.LIFE, 2, Aspect.LIFE, 2);
		add(ItemTypes.RED_FLOWER, Aspect.LIFE, 2);
		add(ItemTypes.REDSTONE, Aspect.MACHINE, 1);
		add(ItemTypes.REDSTONE_BLOCK, Aspect.MACHINE, 9);
		add(ItemTypes.REDSTONE_LAMP, Aspect.MACHINE, 4, Aspect.LIGHT, 4);
		add(ItemTypes.REDSTONE_ORE, Aspect.STONE, 2);
		add(ItemTypes.REDSTONE_TORCH);
		add(ItemTypes.REEDS, Aspect.LIFE, 1);
		add(ItemTypes.REPEATER, Aspect.MACHINE, 8, Aspect.STONE, 4);
		add(ItemTypes.ROTTEN_FLESH, Aspect.DEATH, 1);
		...
		add(ItemTypes.SAPLING, Aspect.LIFE, 4, Aspect.WOOD, 1);
		add(ItemTypes.SHEARS, Aspect.TOOL, 2, Aspect.METAL, 8);
		add(ItemTypes.SIGN, Aspect.WOOD, 8);
		add(ItemTypes.SKULL, Aspect.DEATH, 8);
		...
		add(ItemTypes.SOUL_SAND, Aspect.LIFE, 1, Aspect.EARTH, 1, Aspect.DEATH, 1, Aspect.DARKNESS, 1);
		add(ItemTypes.SPECKLED_MELON, Aspect.LIFE, 4, Aspect.LIFE, 1);
		add(ItemTypes.SPIDER_EYE, Aspect.BEAST, 2);
		...
		add(ItemTypes.STICKY_PISTON, Aspect.MACHINE, 8, Aspect.STONE, 8, Aspect.WOOD, 4, Aspect.MOVEMENT, 4,
				Aspect.BEAST, 2);
		...
		add(ItemTypes.SUGAR, Aspect.LIFE, 1);

		add(ItemTypes.TALLGRASS, Aspect.WIND, 1, Aspect.LIFE, 1);
		add(ItemTypes.TNT, Aspect.DESTRUCTION, 16);
		...
		add(ItemTypes.VINE, Aspect.LIFE, 2);

		add(ItemTypes.WATER_BUCKET, Aspect.METAL, 24, Aspect.WATER, 8);
		add(ItemTypes.WATERLILY, Aspect.LIFE, 2, Aspect.WATER, 4);
		add(ItemTypes.WHEAT, Aspect.LIFE, 1, Aspect.LIFE, 1);
		add(ItemTypes.WHEAT_SEEDS, Aspect.LIFE, 1);
		...
		add(ItemTypes.WRITABLE_BOOK, Aspect.KNOWLEDGE, 8, Aspect.BEAST, 1, Aspect.LIFE, 4);
		add(ItemTypes.WRITTEN_BOOK, Aspect.KNOWLEDGE, 8, Aspect.LIFE, 4);

		add(ItemTypes.YELLOW_FLOWER, Aspect.LIFE, 1);
