...
public class BukkitAspectRegister implements Manager {
	...
	public void onEnable() {
		...
		add(Material.INK_SACK, Aspect.CONSTRUCT, 1);
		...
		add(Material.SMOOTH_BRICK, Aspect.STONE, 2);
		...
		/* TODO Add missing materials
		for (Material mat : Material.values()) {
			if (!this.itemTypeList.contains(mat)) {
	...
	private void add(Material type, AspectList list) {
